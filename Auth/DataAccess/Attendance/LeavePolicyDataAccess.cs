    ...
    public class LeavePolicyDataAccess
    {
        ...
        public DynamicParameters leavePolicyParameterBinding(LeavePolicy leavePolicy, int operationType)
        {
            ...
            if (operationType == (int)GlobalEnumList.DBOperation.Create || operationType == (int)GlobalEnumList.DBOperation.Update)
            {
                ...
                parameters.Add("@param_leave_head_id", leavePolicy.leave_head_id ?? 0, DbType.Int32);
                parameters.Add("@param_default_leave_balance_day", leavePolicy.default_leave_balance_day ?? 0, DbType.Decimal);
                parameters.Add("@param_default_leave_balance_min", leavePolicy.default_leave_balance_min ?? 0, DbType.Int32);
                parameters.Add("@param_max_enjoyable_limit_min", leavePolicy.max_enjoyable_limit_min ?? 0, DbType.Int32);
                parameters.Add("@param_max_carry_leave_limit_min", leavePolicy.max_carry_leave_limit_min ?? 0, DbType.Int32);
                parameters.Add("@param_max_carry_year", leavePolicy.max_carry_year ?? 0, DbType.Int32);
                ...
                parameters.Add("@param_attachment_required_for_min", leavePolicy.attachment_required_for_min??0, DbType.Int32);
                ...
                parameters.Add("@param_purpose_required_for_min", leavePolicy.purpose_required_for_min ?? 0, DbType.Int32);
                parameters.Add("@param_is_leave_area_required", leavePolicy.is_leave_area_required, DbType.Boolean);
                parameters.Add("@param_area_required_for_min", leavePolicy.area_required_for_min ?? 0, DbType.Int32);
                parameters.Add("@param_is_responsible_person_required", leavePolicy.is_responsible_person_required, DbType.Boolean);
                parameters.Add("@param_responsible_person_required_for_min", leavePolicy.responsible_person_required_for_min ?? 0, DbType.Int32);
                parameters.Add("@param_is_negetive_balance", leavePolicy.is_negetive_balance, DbType.Boolean);
                parameters.Add("@param_max_negetive_balance_min", leavePolicy.max_negetive_balance_min ?? 0, DbType.Int32);
                parameters.Add("@param_notice_period", leavePolicy.notice_period ?? 0, DbType.Int32);
                parameters.Add("@param_notice_required_for_min", leavePolicy.notice_required_for_min ?? 0, DbType.Int32);
                parameters.Add("@param_earn_day_count", leavePolicy.earn_day_count ?? 0, DbType.Int32);
                ...
                parameters.Add("@param_encash_leave_balance_limit_min", leavePolicy.encash_leave_balance_limit_min ?? 0, DbType.Int32);
                parameters.Add("@param_encash_fixed_amount", leavePolicy.encash_fixed_amount, DbType.Decimal);
                parameters.Add("@param_encash_amount_percent", leavePolicy.encash_amount_percent ?? 0, DbType.Int32);
                parameters.Add("@param_is_gross", leavePolicy.is_gross, DbType.Boolean);
                parameters.Add("@param_salary_head_id", leavePolicy.salary_head_id ?? 0, DbType.Int32);
                parameters.Add("@param_activation_days", leavePolicy.activation_days ?? 0, DbType.Int32);
