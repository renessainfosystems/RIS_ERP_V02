    ...
    public class AbsenteeismPolicyDataAccess
    {
        ...
        public async Task<dynamic> GetAllAbsenteeismPolicy()
        {
            ...
            try
            {
                ...
                var sql = " SELECT * FROM [Attendance].[View_AbsenteeismPolicy] s " + 
        ...
        public async Task<dynamic> GetAllAbsenteeismPolicyForDP()
        {
            ...
            try
            {
                ...
                parameters.Add("@param_company_group_id", company_group_id);
                parameters.Add("@param_company_id", company_id);
                var sql = " SELECT S.absenteeism_policy_id,S.absenteeism_policy_name FROM [Attendance].[View_AbsenteeismPolicy] s " +
