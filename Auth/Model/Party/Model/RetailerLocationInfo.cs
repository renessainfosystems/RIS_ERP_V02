...
{
    [Table("Retailer_Location_Info", Schema = "Party")]
    public class RetailerLocationInfo
    {
        [Key]
        public int retailer_location_info_id { get; set; }
        public int retailer_info_id { get; set; }
        public string retailer_location_info_code { get; set; }
        public string retailer_location_info_name { get; set; }
        public string retailer_location_info_short_name { get; set; }
