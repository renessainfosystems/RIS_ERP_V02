...
{
    [Table("Retailer_Contact_Info", Schema = "Party")]
    public class RetailerContactInfo
    {
        [Key]
        public int retailer_contact_info_id { get; set; }
        public int retailer_info_id { get; set; }
        public string retailer_contact_info_code { get; set; }
