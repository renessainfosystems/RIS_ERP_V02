...
export class DealerAssessmentComponent  implements OnInit {
    ...
    deleteDealerinfo() {
        ...
        let dealerinfoId = this.rowData.DealerInfoId;
        this.dealerAssessmentService.deleteDealerInfo(dealerinfoId).subscribe(data => {
    ...
    SaveDealerinfo() {
        ...
        if (this.isDealerinfoEdit) {
            ...
            this.dealerAssessmentService.updateDealerInfo(formData).subscribe(result => {
            ...
            this.dealerAssessmentService.createDealerInfo(formData).subscribe(
                result => {
                    this.notifyService.ShowNotification(result.MessageType, result.CurrentMessage);
                    if (result.MessageType == 1) {
                        this.dealerinfoList.unshift(result.Data);
    ...
    SaveDealerContactInfo() {
        ...
        if (this.isDealerContactinfoEdit) {
            ...
            this.dealerAssessmentService.updateDealerContactInfo(formData).subscribe(result => {
            ...
            formData.append("dealer_info_id", this.rowData.DealerInfoId);
            this.dealerAssessmentService.createDealerContactInfo(formData).subscribe(
                result => {
                    this.notifyService.ShowNotification(result.MessageType, result.CurrentMessage);
    ...
    loadDealerContactinfoToEdit() {
        ...
        this.dealerAssessmentService.getDealerContactInfoById(dealerContactinfoId).subscribe(data => {
            if (data != null) {
    ...
    deleteDealerContactinfo() {
        ...
        let dealerContactinfoId = this.rowDataContact.DealerContactInfoId;
        this.dealerAssessmentService.deleteDealerContactInfo(dealerContactinfoId).subscribe(data => {
            if (data.MessageType == 1) {
                this.dealercontactinfoList.splice(this.dealercontactinfoList.findIndex(item => item.DealerContactInfoId === data.dealerContactinfoId), 1);
            }
            this.notifyService.ShowNotification(data.MessageType, data.CurrentMessage)
    ...
    SaveDealerLocationInfo() {
        ...
        if (this.isDealerLocationinfoEdit) {
            ...
            this.dealerAssessmentService.updateDealerLocationInfo(formData).subscribe(result => {
            ...
            formData.append("dealer_info_id", this.rowData.DealerInfoId);
            this.dealerAssessmentService.createDealerLocationInfo(formData).subscribe(
                result => {
                    this.notifyService.ShowNotification(result.MessageType, result.CurrentMessage);
                    if (result.MessageType == 1) {
                        this.dealerlocationinfoList.unshift(result.Data);
    ...
    loadDealerLocationinfoToEdit() {
        ...
        this.dealerAssessmentService.getDealerLocationInfoById(dealerLocationinfoId).subscribe(data => {
            if (data != null) {
    ...
    deleteDealerLocationinfo() {
        ...
        let dealerLocationinfoId = this.rowDataLocation.DealerLocationInfoId;
        this.dealerAssessmentService.deleteDealerLocationInfo(dealerLocationinfoId).subscribe(data => {
            if (data.MessageType == 1) {
                this.dealerlocationinfoList.splice(this.dealerlocationinfoList.findIndex(item => item.DealerLocationInfoId === data.dealerLocationinfoId), 1);
            }
            this.notifyService.ShowNotification(data.MessageType, data.CurrentMessage)
    ...
    SaveDealerDocumentInfo() {
        ...
        if (this.isDealerDocumentinfoEdit) {
            ...
            this.dealerAssessmentService.updateDealerDocumentInfo(formData).subscribe(result => {
            ...
            this.dealerAssessmentService.createDealerDocumentInfo(formData).subscribe(
                result => {
                    this.notifyService.ShowNotification(result.MessageType, result.CurrentMessage);
                    if (result.MessageType == 1) {
                        this.dealerdocumentinfoList.unshift(result.Data);
    ...
    loadDealerDocumentinfoToEdit() {
        ...
        this.dealerAssessmentService.getDealerDocumentInfoById(dealerDocumentinfoId).subscribe(data => {
            if (data != null) {
            ...
            this.dealerdocumentForm.controls['image_file'].setValue(data.FileUpload);
    ...
    deleteDealerDocumentinfo() {
        ...
        this.rowSelected = true;
        let dealerDocumentinfoId = this.rowDataDocument.DealerDocumentInfoId;
        this.dealerAssessmentService.deleteDealerDocumentInfo(dealerDocumentinfoId).subscribe(data => {
            if (data.MessageType == 1) {
                this.dealerdocumentinfoList.splice(this.dealerdocumentinfoList.findIndex(item => item.DealerDocumentInfoId === data.dealerDocumentinfoId), 1);
            }
            this.notifyService.ShowNotification(data.MessageType, data.CurrentMessage)
    ...
    SaveDealerCreditInfo() {
        ...
        if (this.isDealerCreditinfoEdit) {
            ...
            this.dealerAssessmentService.updateDealerCreditInfo(formData).subscribe(result => {
            ...
            this.dealerAssessmentService.createDealerCreditInfo(formData).subscribe(
                result => {
                    this.notifyService.ShowNotification(result.MessageType, result.CurrentMessage);
                    if (result.MessageType == 1) {
                        this.dealercreditinfoList.unshift(result.Data);
    ...
    loadDealerCreditinfoToEdit() {
        ...
        this.dealerAssessmentService.getDealerCreditInfoById(dealerCreditinfoId).subscribe(data => {
            if (data != null) {
    ...
    deleteDealerCreditinfo() {
        ...
        this.rowSelected = true;
        let dealerCreditinfoId = this.rowDataCredit.DealerCreditInfoId;
        this.dealerAssessmentService.deleteDealerCreditInfo(dealerCreditinfoId).subscribe(data => {
            if (data.MessageType == 1) {
    ...
    creditApprove() {
        ...
        let dealerCreditinfoId = this.rowDataCredit.DealerCreditInfoId;
        let dealerInfoId = this.rowDataCredit.DealerInfoId;
        this.dealerAssessmentService.approve(dealerCreditinfoId, dealerInfoId).subscribe(result => {
            this.notifyService.ShowNotification(result.MessageType, result.CurrentMessage);
            if (result.MessageType == 1) {
                this.dealercreditinfoList.splice(this.dealercreditinfoList.findIndex(item => item.DealerCreditInfoId === dealerCreditinfoId), 1);
                this.dealercreditinfoList.unshift(result.Data);
