...
export class MfsService {
  ...
  getAllMfs(): Observable<any[]> {
    ...
    return this.http.get<any[]>(this.ipconfig.base_IP + 'Mfs/GetAllMfs');
  ...
  getAllCountryCboList(): Observable<Mfs[]> {
    return this.http.get<Mfs[]>(this.ipconfig.base_IP + 'Country/CountryCboList');
  }
