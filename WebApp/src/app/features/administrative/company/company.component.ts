...
export class CompanyComponent implements OnInit {
  ...
  loadCompanyToEdit() {
    ...
    this.CompanyService.getCompanyById(companyId).subscribe(data => {
      ...
      this.companyForm.controls['companyGroupObj'].setValue(data.company_group_id);
      this.companyForm.controls['countryObj'].setValue(data.country_id);
      this.onSelectByCountryId(data.country_id);
      this.companyForm.controls['divisionObj'].setValue(data.division_id);
      this.onSelectByDivisionId(data.division_id);
      this.companyForm.controls['districtObj'].setValue(data.district_id);
      this.companyForm.controls['currencyObj'].setValue(data.currency_id);
